        ...
        <div class="modal-dialog" role="document" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?=form_open('circle/change_password');?>
                    <?=form_hidden('user_id', $data['user'][0]->user_id); ?>
                    <table class="table">
                    <tbody>
                        <tr>
    ...
    <div class="modal fade" id="resetPass" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <?php $class = array('class'=>'form-control', 'required'=>'required');?>
                <div class="modal-body">
                    <?=form_open('circle/reset_password');?>
    ...
    <div class="modal fade" id="addEditUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?=form_open('circle/add_edit_user');?>
        ...
        <div class="card col-md-6">
            <div class="card-body">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-1">
                        <?php echo anchor('#', 'Edit', array('class'=>'btn btn-primary text-white', "data-toggle"=>"modal", "data-target"=>"#editModal")); ?>
                    </div> -->
                    <div class="col-lg-2">
                        <?php echo anchor('#', 'Change Password', array('class'=>'btn btn-warning text-white', "data-toggle"=>"modal", "data-target"=>"#passModal")); ?>
                    </div>
                </div>
                <!-- <?=print_r($data['user'][0]);?> -->
                <table class="table">
                    <tbody>
                        <tr>
                            <td>PEN : </td>
                            <td class="text-success"><?=$data['user'][0]->name?></td>
                        </tr>
                        <tr>
                            <td>Fullname : </td>
                            <td class="text-success"><?=$data['user'][0]->fullname?></td>
                        </tr>
                        <tr>
                            <td>Designation : </td>
                            <td class="text-success"><?=$data['user'][0]->designation?></td>
                        </tr>
                        <tr>
                            <td>Email ID : </td>
                            <td class="text-success"><?=$data['user'][0]->email_id?></td>
                        </tr>
                        <tr>
                            <td>Phone No. : </td>
                            <td class="text-success"><?=$data['user'][0]->phone_no?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Kerala Cheif Engineer : </td>
                                <td class="text-success"><?=$data['ce'][0]->designation.' '.$data['ce'][0]->fullname ?></td>
                            </tr>
    ...
    <div class="row">
        ...
        <div class="card col-lg-12">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="card-title">Division Users</h4>
                    </div>
                ...
                <table class="table">
                    <thead>
                        <tr class="bg-primary text-white">
                            <th class="font-bold">Division</th>
                            <th>PEN</th>
                            <th>Designation</th>
                            <th>Fullname</th>
                            <th>Email ID</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=anchor('#', 'Edit', array('class'=>'btn btn-outline-primary', "data-toggle"=>"modal", "data-target"=>"#addEditUser", "onclick"=>"fillEditForm($id, '$sid', '$nm', '$did', '$fn', '$em', '$ph')")); ?>
