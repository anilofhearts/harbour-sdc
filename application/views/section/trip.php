                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><?=isset($data['trips_today']) ? $data['trips_today'] : 0?></td>
                            </tr>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td class="text-danger">No. of Trips</td>
                                <td><?=isset($data['trips_all']) ? $data['trips_all'] : 0?></td>
                            </tr>
                        ...
                        <tfoot>
                            <tr class="text-success">
                                ...
                                <td class="font-bold"><?php 
                                    $est_ttl = isset($data['est_ttl']) ? $data['est_ttl'] : 0;
                                    if ($est_ttl > 0) {
                                        echo round((($icnet/1000)/($est_ttl))*100,-1) . ' %';
                                    } else {
                                        echo '0 %';
                                    }
                                ?></td>
                            ...
                            <tr class="text-success">
                                ...
                                <td class="font-bold"><?php 
                                    $ttl_exp = isset($data['ttl_exp']) && isset($data['ttl_exp']->ttl_exp) ? $data['ttl_exp']->ttl_exp : 0;
                                    $ttl_cost = isset($data['est_ttl_cost']) && isset($data['est_ttl_cost']->ttl_cost) ? $data['est_ttl_cost']->ttl_cost : 0;
                                    if ($ttl_cost > 0) {
                                        echo round(($ttl_exp/$ttl_cost)*100,2) . ' %';
                                    } else {
                                        echo '0 %';
                                    }
                                ?></td>
