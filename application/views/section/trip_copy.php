...
document.getElementById("snap").setAttribute(
        'src',"http://127.0.0.1:8001/snapshot.jpg");
                        ...
                        <div class="col-md-6 align-middle" style="text-align: center;"> <label id="wtlabel" style="font-size: 24px;">Gross Weight</label>
                            <h1><span id="weight" class="badge badge-pill badge-success weight">0</span></h1>
                            <input type="hidden" id="weight_com" name="weight" />
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                    ...
                    <table id="trip_table" class="table table-bordered table-dark">
                        ...
                        <tbody>
                            ...
                            <tr class="<?=$color?>">
                              ...
                              <!-- <td>
                                <?php echo anchor("editTrip/$trip->trip_id", '<i class="mdi mdi-lead-pencil"></i>', ['data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'Edit Trip']); ?>
                                <?php echo anchor("deleteTrip/$trip->trip_id", '<i class="mdi mdi-delete text-danger"></i>', ['data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'Delete Trip','onClick'=>"return doConfirm();"]); ?>
                              </td> -->
                            </tr>
                            <?php endforeach;} ?>
                        </tbody>
