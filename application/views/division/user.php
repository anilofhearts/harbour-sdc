            ...
            <div class="modal-dialog" role="document" style="max-width: 500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('division/change_password'); ?>
        ...
        <div class="modal fade" id="resetPass" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="max-width: 500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('division/reset_password'); ?>
                        <?= form_hidden('user_id', '', ['id' => 'reset_user_id']); ?>
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>New Password :</td>
        ...
        <div class="modal fade" id="addEditUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="max-width: 500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('division/add_edit_user'); ?>
                        <?= form_hidden('user_id', '', ['id' => 'user_id']); ?>
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>Subdivision :</td>
                                    <td>
                                        <select name="section_id" id="section_id" class="form-control" required="required">
                                            ...
                                            <?php foreach ($data['subdivisions'] as $sub): ?>
                                                <option value="<?= html_escape($sub->subdivision_id) ?>"><?= html_escape($sub->subdivision) ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
        ...
        <div class="row">
            <div class="card col-md-10">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10">
                            <h4 class="card-title">Sub Division Users</h4>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th class="font-bold">Subdivision</th>
                                <th>PEN</th>
                                <th>Designation</th>
                                <th>Fullname</th>
                                <th>Email ID</th>
                        ...
                        <tbody>
                            <?php foreach ($data['users'] as $usr): ?>
                                <tr>
                                    <td><?= html_escape($usr['subdivision']); ?></td>
                                    ...
                                    <td>
                                        <?= anchor('#', 'Edit', ['class' => 'btn btn-outline-primary', "data-toggle" => "modal", "data-target" => "#addEditUser", "onclick" => "fillEditForm('" . html_escape($usr['user_id']) . "', '" . html_escape($usr['section_id']) . "', '" . html_escape($usr['name']) . "', '" . html_escape($usr['designation_id']) . "', '" . html_escape($usr['fullname']) . "', '" . html_escape($usr['email_id']) . "', '" . html_escape($usr['phone_no']) . "')"]); ?>
                                        <?= anchor('#', 'Reset Password', ['class' => 'btn btn-outline-warning', "data-toggle" => "modal", "data-target" => "#resetPass", "onclick" => "fillResetForm('" . html_escape($usr['user_id']) . "')"]); ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script type="text/javascript">
    function fillEditForm(id, sectionId, name, designationId, fullname, emailId, phoneNo) {
