        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Division Info</h4>
                    <div class="ms-auto text-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Circle</a></li>
                                ...
                                if (isset($division)) {
                                    ...
                                    foreach ($division as $data) {
                                        echo "<tr>
                                            <td>$i</td>
                                            <td>$data->division</td>
                                            <td>$data->circle &raquo; $data->division</td>
                                            <td><button class='btn btn-sm btn-primary' onclick=\"view_data('division','$data->division_id','$data->division')\">Edit</button></td>
                                            <td>
                                                <button 
                                                    class='btn btn-sm btn-danger' 
                                                    data-table='division' 
                                                    data-id='$data->division_id' 
