                        ...
                        <tr>
                            ...
                            <td><select name="section_id" id="section_id" class="form-control" required="required">
                                ...
                                <?php foreach($data['circles'] as $cir): ?>
                                    <option value="<?=$cir->circle_id?>" selected=""><?=$cir->circle?></option>
                                <?php endforeach; ?>
                            </select> </td>
                        </tr>
                        <tr>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td><?=$data['circle'][0]->circle?> Circle : </td>
                                <td class="text-success"><?=$data['cirUser'][0]->designation.' '.$data['cirUser'][0]->fullname ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
