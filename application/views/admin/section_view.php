        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Section Info</h4>
                                ...
                                if (isset($section)) {
                                    ...
                                    foreach ($section as $data) {
                                        echo "<tr>
                                            <td>$i</td>
                                            <td>$data->section</td>
                                            <td>$data->circle &raquo; $data->subdivision &raquo; $data->section</td>
                                            <td><button class='btn btn-sm btn-primary' onclick=\"view_data('section','$data->section_id','$data->section')\">Edit</button></td>
                                            ...
                                            <td><button 
                                                 ...
                                                 <td class=center><a href='manage_users/section/$data->section' class='btn btn-sm btn-warning'>Users</a></td>
                                        </tr>";
                                        $i++;
                                    }
                                }
